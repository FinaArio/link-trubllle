...
class Coin extends Component {
    ...
    renderPrice_table_Charts(prices, index) {
        ...
        return (
            <tr key={index}><td><Link to={`trade/${prices.name}`}>{prices.symbol}</Link></td><td>{prices.price_usd}$ </td><td><a style={{ color }}>({percent})%</a></td><td>Short</td></tr>
        )
    }
                ...
                ? <div>
                    <div>
                        <div className="balance-header">
                            <div className="header-overlay">
                                ...
                                <div className="price-header-content">
                                    ...
                                    <p className="price-header-text"><a href='#' style={{ color: 'orange' }}>Sing in</a> and get 10$ deposits on balance </p>
                                </div>{/* header-content */}
                            </div>{/* header-overlay */}
                        </div>{/* balance-header */}
                                ...
                                <div className="trade-form">
                                    ...
                                    <form action="get">
                                        ...
                                        <div className="trade-form-btn-container">
                                            <button className="green-btn">Button 1</button>
                                            <button className="orange-btn">Button 2</button>
                        ...
                        <div className="balance-info">
                            <div className="wrapper">
                                <h4><p className='colpb'>Cryptocurrency</p></h4><br />
